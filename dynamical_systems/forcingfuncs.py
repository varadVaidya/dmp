...
def get_weights_from_forcing_functions(forcing_funcs,alpha_x,xvalues,noBasis,plot = True, return_weights = False):
    ...
    Args: \n
        ...
        xvalues (1D numpy array): values in time dimension\n
    ...
    if plot is True:
        ...
        plt.figure()
        plt.title('Basis functions from function')
